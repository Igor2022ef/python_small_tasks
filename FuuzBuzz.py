...
'''
Вопросы:
1. Постоянно вылезает None при реализации кода (декоратора видимо), как отыскать откуда
...
5. Есть еще вопрос закомментирован в одном из подсмотренных вариантов
'''
